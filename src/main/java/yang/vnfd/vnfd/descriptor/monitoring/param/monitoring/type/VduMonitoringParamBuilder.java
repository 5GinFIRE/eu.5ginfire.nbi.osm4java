...
public class VduMonitoringParamBuilder implements Builder<VduMonitoringParam> {
    ...
    private yang.vnfd.vnfd.descriptor.monitoring.param.monitoring.type.vdu.monitoring.param.VduMonitoringParam _vduMonitoringParam;
    ...
    public yang.vnfd.vnfd.descriptor.monitoring.param.monitoring.type.vdu.monitoring.param.VduMonitoringParam getVduMonitoringParam() {
    ...
    public VduMonitoringParamBuilder setVduMonitoringParam(final yang.vnfd.vnfd.descriptor.monitoring.param.monitoring.type.vdu.monitoring.param.VduMonitoringParam value) {
    ...
    private static final class VduMonitoringParamImpl implements VduMonitoringParam {
        ...
        private final yang.vnfd.vnfd.descriptor.monitoring.param.monitoring.type.vdu.monitoring.param.VduMonitoringParam _vduMonitoringParam;
