...
public class VnfMetricBuilder implements Builder<VnfMetric> {
    ...
    private yang.vnfd.vnfd.descriptor.monitoring.param.monitoring.type.vnf.metric.VnfMetric _vnfMetric;
    ...
    public yang.vnfd.vnfd.descriptor.monitoring.param.monitoring.type.vnf.metric.VnfMetric getVnfMetric() {
        return _vnfMetric;
    }
    ...
    public VnfMetricBuilder setVnfMetric(final yang.vnfd.vnfd.descriptor.monitoring.param.monitoring.type.vnf.metric.VnfMetric value) {
    ...
    private static final class VnfMetricImpl implements VnfMetric {
        ...
        private final yang.vnfd.vnfd.descriptor.monitoring.param.monitoring.type.vnf.metric.VnfMetric _vnfMetric;
