...
public class InitialServicePrimitiveBuilder implements Builder<InitialServicePrimitive> {
    ...
    public InitialServicePrimitiveBuilder(ns.yang.nfvo.mano.types.rev170208.EventConfig arg) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof ns.yang.nfvo.mano.types.rev170208.EventConfig) {
            this._seq = ((ns.yang.nfvo.mano.types.rev170208.EventConfig)arg).getSeq();
            this._name = ((ns.yang.nfvo.mano.types.rev170208.EventConfig)arg).getName();
            this._userDefinedScript = ((ns.yang.nfvo.mano.types.rev170208.EventConfig)arg).getUserDefinedScript();
            this._parameter = ((ns.yang.nfvo.mano.types.rev170208.EventConfig)arg).getParameter();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[model.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.EventConfig]");
    }
