...
public class ScalingGroupDescriptorBuilder implements Builder<ScalingGroupDescriptor> {
    ...
    public static final class ScalingGroupDescriptorImpl implements ScalingGroupDescriptor {
    	...
    	public ScalingGroupDescriptorImpl(){
    		this( new ScalingGroupDescriptorBuilder() );
    	}
