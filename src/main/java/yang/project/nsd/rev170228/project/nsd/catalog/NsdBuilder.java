...
import yang.project.nsd.rev170228.nsd.vnf.dependency.VnfDependency;
...
public class NsdBuilder implements Builder<Nsd> {
    ...
    public NsdBuilder(yang.project.nsd.rev170228.NsdMonitoringParam arg) {
        this._monitoringParam = arg.getMonitoringParam();
    }
    public NsdBuilder(yang.project.nsd.rev170228.NsdVnfDependency arg) {
        this._vnfDependency = arg.getVnfDependency();
    }
    public NsdBuilder(yang.project.nsd.rev170228.NsdVld arg) {
        this._vld = arg.getVld();
    }
    public NsdBuilder(yang.project.nsd.rev170228.NsdConstituentVnfd arg) {
        this._constituentVnfd = arg.getConstituentVnfd();
    }
    public NsdBuilder(yang.project.nsd.rev170228.NsdPlacementGroups arg) {
        this._placementGroups = arg.getPlacementGroups();
    }
    public NsdBuilder(yang.project.nsd.rev170228.NsdServicePrimitive arg) {
     ...
     * <li>model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdConstituentVnfd</li>
     * <li>model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdMonitoringParam</li>
     * <li>model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdServicePrimitive</li>
     * <li>model.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.IpProfileList</li>
     * <li>model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdVld</li>
     * <li>model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdVnfDependency</li>
     * <li>model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdPlacementGroups</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof yang.project.nsd.rev170228.NsdConstituentVnfd) {
            this._constituentVnfd = ((yang.project.nsd.rev170228.NsdConstituentVnfd)arg).getConstituentVnfd();
            isValidArg = true;
        }
        if (arg instanceof yang.project.nsd.rev170228.NsdMonitoringParam) {
            this._monitoringParam = ((yang.project.nsd.rev170228.NsdMonitoringParam)arg).getMonitoringParam();
            isValidArg = true;
        }
        if (arg instanceof yang.project.nsd.rev170228.NsdServicePrimitive) {
            this._servicePrimitive = ((yang.project.nsd.rev170228.NsdServicePrimitive)arg).getServicePrimitive();
            isValidArg = true;
        }
        ...
        if (arg instanceof yang.project.nsd.rev170228.NsdVld) {
            this._vld = ((yang.project.nsd.rev170228.NsdVld)arg).getVld();
            isValidArg = true;
        }
        if (arg instanceof yang.project.nsd.rev170228.NsdVnfDependency) {
            this._vnfDependency = ((yang.project.nsd.rev170228.NsdVnfDependency)arg).getVnfDependency();
            isValidArg = true;
        }
        if (arg instanceof yang.project.nsd.rev170228.NsdPlacementGroups) {
            this._placementGroups = ((yang.project.nsd.rev170228.NsdPlacementGroups)arg).getPlacementGroups();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[model.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon, model.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.InputParameterXpath, model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdConstituentVnfd, model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdMonitoringParam, model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdServicePrimitive, model.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.IpProfileList, model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdVld, model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdVnfDependency, model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdPlacementGroups]");
    }
