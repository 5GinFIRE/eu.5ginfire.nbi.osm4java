package yang.project.nsd.rev170228.nsr.nsd.placement.groups.placement.groups;
...
public class MemberVnfdBuilder implements Builder<MemberVnfd> {
	...
	public MemberVnfdBuilder addAugmentation(Class<? extends Augmentation<MemberVnfd>> augmentationType,
			Augmentation<MemberVnfd> augmentationValue) {
	...
	private static final class MemberVnfdImpl implements MemberVnfd {
		...
		private Map<Class<? extends Augmentation<MemberVnfd>>, Augmentation<MemberVnfd>> augmentation = Collections
				.emptyMap();
		...
		public boolean equals(Object obj) {
			...
			if (getClass() == obj.getClass()) {
				...
				for (Map.Entry<Class<? extends Augmentation<MemberVnfd>>, Augmentation<MemberVnfd>> e : augmentation
						.entrySet()) {
