package yang.project.nsd.rev170228.nsr.nsd.vld;
...
import yang.project.nsd.rev170228.nsr.nsd.vld.vld.VnfdConnectionPointRef;
...
public class VldBuilder implements Builder<Vld> {
	...
	public VldBuilder(
			ns.yang.nfvo.mano.types.rev170208.ProviderNetwork arg) {
		this._providerNetwork = arg.getProviderNetwork();
	}
	...
	public void fieldsFrom(DataObject arg) {
		...
		if (arg instanceof ns.yang.nfvo.mano.types.rev170208.ProviderNetwork) {
			this._providerNetwork = ((ns.yang.nfvo.mano.types.rev170208.ProviderNetwork) arg)
					.getProviderNetwork();
			isValidArg = true;
		}
		if (arg instanceof yang.base.NsdVldCommon) {
			this._id = ((yang.base.NsdVldCommon) arg)
					.getId();
			this._name = ((yang.base.NsdVldCommon) arg)
					.getName();
			this._shortName = ((yang.base.NsdVldCommon) arg)
					.getShortName();
			this._vendor = ((yang.base.NsdVldCommon) arg)
					.getVendor();
			this._description = ((yang.base.NsdVldCommon) arg)
					.getDescription();
			this._version = ((yang.base.NsdVldCommon) arg)
					.getVersion();
			this._type = ((yang.base.NsdVldCommon) arg)
					.getType();
			this._rootBandwidth = ((yang.base.NsdVldCommon) arg)
					.getRootBandwidth();
			this._leafBandwidth = ((yang.base.NsdVldCommon) arg)
					.getLeafBandwidth();
			this._mgmtNetwork = ((yang.base.NsdVldCommon) arg)
					.isMgmtNetwork();
			this._initParams = ((yang.base.NsdVldCommon) arg)
					.getInitParams();
			isValidArg = true;
		}
		CodeHelpers.validValue(isValidArg, arg,
				"[model.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.ProviderNetwork, model.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.NsdVldCommon]");
	}
	...
	public VldBuilder addAugmentation(Class<? extends Augmentation<Vld>> augmentationType,
			Augmentation<Vld> augmentationValue) {
