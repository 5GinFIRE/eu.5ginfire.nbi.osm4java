...
import yang.project.nsd.rev170228.NsdPlacementGroups;
import yang.project.nsd.rev170228.nsd.placement.groups.placement.groups.MemberVnfd;
 ...
 * 
 * <p>
 * To create instances of this class use {@link PlacementGroupsBuilder}.
 * 
 * @see PlacementGroupsBuilder
 * @see PlacementGroupsKey
 *
 */
public interface PlacementGroups extends ChildOf<NsdPlacementGroups>, Augmentable<PlacementGroups>, PlacementGroupInfo,
	 ...
	 *
	 *
	 * @return <code>java.util.List</code> <code>memberVnfd</code>, or
