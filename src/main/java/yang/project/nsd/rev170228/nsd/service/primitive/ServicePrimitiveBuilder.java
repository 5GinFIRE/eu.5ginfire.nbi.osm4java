...
public class ServicePrimitiveBuilder implements Builder<ServicePrimitive> {
	...
	Map<Class<? extends Augmentation<ServicePrimitive>>, Augmentation<ServicePrimitive>> augmentation = Collections
			.emptyMap();
	...
	public ServicePrimitiveBuilder(
			ns.yang.nfvo.mano.types.rev170208.UiPrimitiveGroup arg) {
	...
	public void fieldsFrom(DataObject arg) {
		...
		if (arg instanceof ns.yang.nfvo.mano.types.rev170208.UiPrimitiveGroup) {
			this._parameterGroup = ((ns.yang.nfvo.mano.types.rev170208.UiPrimitiveGroup) arg)
					.getParameterGroup();
			isValidArg = true;
		}
		CodeHelpers.validValue(isValidArg, arg,
				"[model.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.UiPrimitiveGroup]");
	}
	...
	public ServicePrimitiveBuilder addAugmentation(Class<? extends Augmentation<ServicePrimitive>> augmentationType,
			Augmentation<ServicePrimitive> augmentationValue) {
	...
	public ServicePrimitiveBuilder removeAugmentation(
			Class<? extends Augmentation<ServicePrimitive>> augmentationType) {
		if (this.augmentation instanceof HashMap) {
	...
	private static final class ServicePrimitiveImpl implements ServicePrimitive {
		...
		private Map<Class<? extends Augmentation<ServicePrimitive>>, Augmentation<ServicePrimitive>> augmentation = Collections
				.emptyMap();
		...
		public boolean equals(Object obj) {
			...
			if (getClass() == obj.getClass()) {
				...
				for (Map.Entry<Class<? extends Augmentation<ServicePrimitive>>, Augmentation<ServicePrimitive>> e : augmentation
						.entrySet()) {
