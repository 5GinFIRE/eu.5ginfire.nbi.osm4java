...
public class VduMetricBuilder implements Builder<VduMetric> {
    ...
    private ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.monitoring.param.monitoring.type.vdu.metric.VduMetric _vduMetric;
    ...
    public ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.monitoring.param.monitoring.type.vdu.metric.VduMetric getVduMetric() {
        return _vduMetric;
    }
    ...
    public VduMetricBuilder setVduMetric(final ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.monitoring.param.monitoring.type.vdu.metric.VduMetric value) {
    ...
    private static final class VduMetricImpl implements VduMetric {
        ...
        private final ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.monitoring.param.monitoring.type.vdu.metric.VduMetric _vduMetric;
