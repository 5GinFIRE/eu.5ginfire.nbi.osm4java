...
/**
 * Class that builds {@link NsdPlacementGroupMaps} instances.
 * 
 * @see NsdPlacementGroupMaps
 *
 */
public class NsdPlacementGroupMapsBuilder implements Builder<NsdPlacementGroupMaps> {
    ...
    public NsdPlacementGroupMapsBuilder(ns.yang.nfvo.mano.types.rev170208.PlacementGroupInput arg) {
    ...
    public NsdPlacementGroupMapsBuilder(NsdPlacementGroupMaps base) {
        if (base.key() == null) {
            this.key = new NsdPlacementGroupMapsKey(
        ...
        if (base instanceof NsdPlacementGroupMapsImpl) {
            ...
            AugmentationHolder<NsdPlacementGroupMaps> casted =(AugmentationHolder<NsdPlacementGroupMaps>) base;
