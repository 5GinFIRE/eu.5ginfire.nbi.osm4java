...
public class TerminateServicePrimitiveBuilder implements Builder<TerminateServicePrimitive> {
    ...
    Map<Class<? extends Augmentation<TerminateServicePrimitive>>, Augmentation<TerminateServicePrimitive>> augmentation = Collections.emptyMap();

    public TerminateServicePrimitiveBuilder() {
    }
    public TerminateServicePrimitiveBuilder(ns.yang.nfvo.nsr.rev170208.EventServicePrimitive arg) {
    ...
    public TerminateServicePrimitiveBuilder(TerminateServicePrimitive base) {
        if (base.key() == null) {
            this.key = new TerminateServicePrimitiveKey(
                base.getSeq()
            );
    ...
    */
    ...
    public TerminateServicePrimitiveBuilder addAugmentation(Class<? extends Augmentation<TerminateServicePrimitive>> augmentationType, Augmentation<TerminateServicePrimitive> augmentationValue) {
    ...
    public TerminateServicePrimitiveBuilder removeAugmentation(Class<? extends Augmentation<TerminateServicePrimitive>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    private static final class TerminateServicePrimitiveImpl implements TerminateServicePrimitive {
        ...
        private Map<Class<? extends Augmentation<TerminateServicePrimitive>>, Augmentation<TerminateServicePrimitive>> augmentation = Collections.emptyMap();
        ...
        public boolean equals(Object obj) {
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<TerminateServicePrimitive>>, Augmentation<TerminateServicePrimitive>> e : augmentation.entrySet()) {
