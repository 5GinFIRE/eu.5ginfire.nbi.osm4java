...
public class ParameterGroupBuilder implements Builder<ParameterGroup> {
	...
	Map<Class<? extends Augmentation<ParameterGroup>>, Augmentation<ParameterGroup>> augmentation = Collections
			.emptyMap();
	...
	public ParameterGroupBuilder(
			ns.yang.nfvo.mano.types.rev170208.PrimitiveParameterValue arg) {
	...
	public void fieldsFrom(DataObject arg) {
		...
		if (arg instanceof ns.yang.nfvo.mano.types.rev170208.PrimitiveParameterValue) {
			this._parameter = ((ns.yang.nfvo.mano.types.rev170208.PrimitiveParameterValue) arg)
					.getParameter();
			isValidArg = true;
		}
		CodeHelpers.validValue(isValidArg, arg,
				"[model.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.PrimitiveParameterValue]");
	}
	...
	public ParameterGroupBuilder addAugmentation(Class<? extends Augmentation<ParameterGroup>> augmentationType,
			Augmentation<ParameterGroup> augmentationValue) {
	...
	private static final class ParameterGroupImpl implements ParameterGroup {
		...
		private Map<Class<? extends Augmentation<ParameterGroup>>, Augmentation<ParameterGroup>> augmentation = Collections
				.emptyMap();
		...
		public boolean equals(Object obj) {
			...
			if (getClass() == obj.getClass()) {
				...
				for (Map.Entry<Class<? extends Augmentation<ParameterGroup>>, Augmentation<ParameterGroup>> e : augmentation
						.entrySet()) {
