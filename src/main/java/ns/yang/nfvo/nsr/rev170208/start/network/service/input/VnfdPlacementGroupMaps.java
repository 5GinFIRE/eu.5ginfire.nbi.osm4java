package ns.yang.nfvo.nsr.rev170208.start.network.service.input;
...
import ns.yang.nfvo.nsr.rev170208.StartNetworkServiceInput;
import ns.yang.nfvo.nsr.rev170208.start.network.service.input.vnfd.placement.group.maps.SshAuthorizedKey;
import ns.yang.nfvo.nsr.rev170208.start.network.service.input.vnfd.placement.group.maps.User;
 ...
 * 
 * <p>
 * To create instances of this class use {@link VnfdPlacementGroupMapsBuilder}.
 * 
 * @see VnfdPlacementGroupMapsBuilder
 * @see VnfdPlacementGroupMapsKey
 *
 */
public interface VnfdPlacementGroupMaps extends ChildOf<StartNetworkServiceInput>, Augmentable<VnfdPlacementGroupMaps>,
		PlacementGroupInput, Identifiable<VnfdPlacementGroupMapsKey> {
	 ...
	 * leafref, whose target is in a different module.Once that is resovled this
	 * will switched to useleafref
	 *
	 *
	 *
	 * @return <code>model.urn.ietf.params.xml.ns.yang.ietf.yang.types.rev130715.Uuid</code>
	 *         <code>vnfdIdRef</code>, or <code>null</code> if not present
	 */
	@Nullable
	Uuid getVnfdIdRef();
	 ...
	 *
	 *
	 * @return <code>java.lang.Object</code> <code>placementGroupRef</code>, or
