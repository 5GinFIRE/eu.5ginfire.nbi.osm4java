...
import yang.project.nsd.rev170228.nsr.nsd.constituent.vnfd.ConstituentVnfd;
...
public class NsdBuilder implements Builder<Nsd> {
    ...
    public NsdBuilder(yang.project.nsd.rev170228.NsrNsdPlacementGroups arg) {
        this._placementGroups = arg.getPlacementGroups();
    }
    public NsdBuilder(yang.project.nsd.rev170228.NsrNsdVld arg) {
        this._vld = arg.getVld();
    }
    public NsdBuilder(yang.project.nsd.rev170228.NsrNsdVnfDependency arg) {
        this._vnfDependency = arg.getVnfDependency();
    }
    public NsdBuilder(yang.project.nsd.rev170228.NsrNsdServicePrimitive arg) {
        this._servicePrimitive = arg.getServicePrimitive();
    }
    public NsdBuilder(yang.project.nsd.rev170228.NsrNsdConstituentVnfd arg) {
    ...
    public NsdBuilder(yang.project.nsd.rev170228.NsrNsdMonitoringParam arg) {
     ...
     * <ul>
     * <li>model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsrNsdVld</li>
     * <li>model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsrNsdServicePrimitive</li>
     * <li>model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsrNsdConstituentVnfd</li>
     ...
     * <li>model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsrNsdPlacementGroups</li>
     * <li>model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsrNsdVnfDependency</li>
     * <li>model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsrNsdMonitoringParam</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof yang.project.nsd.rev170228.NsrNsdVld) {
            this._vld = ((yang.project.nsd.rev170228.NsrNsdVld)arg).getVld();
            isValidArg = true;
        }
        if (arg instanceof yang.project.nsd.rev170228.NsrNsdServicePrimitive) {
            this._servicePrimitive = ((yang.project.nsd.rev170228.NsrNsdServicePrimitive)arg).getServicePrimitive();
            isValidArg = true;
        }
        if (arg instanceof yang.project.nsd.rev170228.NsrNsdConstituentVnfd) {
            this._constituentVnfd = ((yang.project.nsd.rev170228.NsrNsdConstituentVnfd)arg).getConstituentVnfd();
            isValidArg = true;
        }
        ...
        if (arg instanceof yang.project.nsd.rev170228.NsrNsdPlacementGroups) {
            this._placementGroups = ((yang.project.nsd.rev170228.NsrNsdPlacementGroups)arg).getPlacementGroups();
            isValidArg = true;
        }
        if (arg instanceof yang.project.nsd.rev170228.NsrNsdVnfDependency) {
            this._vnfDependency = ((yang.project.nsd.rev170228.NsrNsdVnfDependency)arg).getVnfDependency();
            isValidArg = true;
        }
        if (arg instanceof yang.project.nsd.rev170228.NsrNsdMonitoringParam) {
            this._monitoringParam = ((yang.project.nsd.rev170228.NsrNsdMonitoringParam)arg).getMonitoringParam();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsrNsdVld, model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsrNsdServicePrimitive, model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsrNsdConstituentVnfd, model.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon, model.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.InputParameterXpath, model.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.IpProfileList, model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsrNsdPlacementGroups, model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsrNsdVnfDependency, model.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsrNsdMonitoringParam]");
    }
