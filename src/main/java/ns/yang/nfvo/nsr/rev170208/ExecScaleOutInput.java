 ...
 * </pre>
 * 
 * The schema path to identify an instance is <i>nsr/exec-scale-out/input</i>
 * 
 * <p>
 * To create instances of this class use {@link ExecScaleOutInputBuilder}.
 * 
 * @see ExecScaleOutInputBuilder
 *
 */
public interface ExecScaleOutInput extends RpcCommon, RpcInput, Augmentable<ExecScaleOutInput> {
	 ...
	 *
	 *
	 * @return <code>java.math.BigInteger</code> <code>instanceId</code>, or
	 *         <code>null</code> if not present
	 */
	@Nullable
