...
/**
 * Class that builds {@link ExecScaleOutOutput} instances.
 * 
 * @see ExecScaleOutOutput
 *
 */
public class ExecScaleOutOutputBuilder implements Builder<ExecScaleOutOutput> {
	...
	Map<Class<? extends Augmentation<ExecScaleOutOutput>>, Augmentation<ExecScaleOutOutput>> augmentation = Collections
			.emptyMap();
	...
	public ExecScaleOutOutputBuilder(ExecScaleOutOutput base) {
		...
		if (base instanceof ExecScaleOutOutputImpl) {
			...
			AugmentationHolder<ExecScaleOutOutput> casted = (AugmentationHolder<ExecScaleOutOutput>) base;
	...
	public ExecScaleOutOutputBuilder addAugmentation(Class<? extends Augmentation<ExecScaleOutOutput>> augmentationType,
			Augmentation<ExecScaleOutOutput> augmentationValue) {
	...
	public ExecScaleOutOutputBuilder removeAugmentation(
			Class<? extends Augmentation<ExecScaleOutOutput>> augmentationType) {
		if (this.augmentation instanceof HashMap) {
	...
	private static final class ExecScaleOutOutputImpl implements ExecScaleOutOutput {
		...
		private Map<Class<? extends Augmentation<ExecScaleOutOutput>>, Augmentation<ExecScaleOutOutput>> augmentation = Collections
				.emptyMap();
		...
		public boolean equals(Object obj) {
			...
			if (getClass() == obj.getClass()) {
				...
				for (Map.Entry<Class<? extends Augmentation<ExecScaleOutOutput>>, Augmentation<ExecScaleOutOutput>> e : augmentation
						.entrySet()) {
