 ...
 * </pre>
 * 
 * The schema path to identify an instance is <i>nsd/nsd-monitoring-param</i>
 *
 */
public interface NsdMonitoringParam extends DataObject {

	public static final QName QNAME = $YangModuleInfoImpl.qnameOf("nsd-monitoring-param");

	/**
	 * @return <code>java.util.List</code> <code>monitoringParam</code>, or
