package ns.yang.nfvo.mano.types.rev170208.cloud.config.user;
...
public class KeyPairBuilder implements Builder<KeyPair> {
    ...
    private static final class KeyPairImpl implements KeyPair {
        ...
        private Map<Class<? extends Augmentation<KeyPair>>, Augmentation<KeyPair>> augmentation = Collections.emptyMap();
        ...
        public boolean equals(Object obj) {
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<KeyPair>>, Augmentation<KeyPair>> e : augmentation.entrySet()) {
