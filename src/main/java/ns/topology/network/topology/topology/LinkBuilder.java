...
public class LinkBuilder implements Builder<Link> {
    ...
    public LinkBuilder(ns.topology.LinkAttributes arg) {
     ...
     * <ul>
     * <li>model.urn.tbd.params.xml.ns.yang.network.topology.rev131021.LinkAttributes</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof ns.topology.LinkAttributes) {
            this._linkId = ((ns.topology.LinkAttributes)arg).getLinkId();
            this._source = ((ns.topology.LinkAttributes)arg).getSource();
            this._destination = ((ns.topology.LinkAttributes)arg).getDestination();
            this._supportingLink = ((ns.topology.LinkAttributes)arg).getSupportingLink();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[model.urn.tbd.params.xml.ns.yang.network.topology.rev131021.LinkAttributes]");
    }
